...
<div class="card mb-3">
    ...
    <i class="fa fa-list"></i><b> <?= $title ?></b>
         <?= anchor('admin/feature/addService', '<i class="fa fa-plus-circle" aria-hidden="true"> Add</i>', 'class="btn btn-sm btn-success float-sm-right"'); ?>
	    </div>
        ...
        foreach($ListData as $service) : ?>
                <tr>
                    ...
                    <td>
                        ...
                        <?= anchor('admin/feature/deleteService/'.$service['id'].'', '<i class="fa fa-trash" aria-hidden="true"></i>', array('class="btn btn-sm btn-danger"','onclick'=>"return confirm('Yakin untuk menghapus data ini?')")); ?>                                               
