...
<span>
    ...
    <button type="button" class="btn btn-danger"><a id="print" href="cetak_pelatihan" target="_blank">Print</a></button>
</span>
<br><br>
<div class="row col-md-12">
    <div class="col-md-3">
...
<script type="text/javascript">
    ...
    function searchByStatus(status){
        $.ajax({
            url:'<?= site_url('admin/hasilsurvey/cari_pelatihan/') ?>'+status ,
            dataType: 'html',
            type: 'POST',
