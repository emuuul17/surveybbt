	...
	<h3 class="heading text-center text-capitalize mb-5">Projects</h3>
		...
		<ul class="portfolio-area clearfix">
			<li class="portfolio-item2" data-id="id-0" data-type="cat-item-4">
				<div>
					<span class="image-block img-hover">
						<a class="image-zoom" href="<?php echo base_url();?>/assets/web/images/g1.jpg" data-gal="prettyPhoto[gallery]">

							<img src="<?php echo base_url();?>/assets/web/images/g1.jpg" class="img-fluid w3layouts agileits" alt="">
			...
			<li class="portfolio-item2" data-id="id-1" data-type="cat-item-2">
				<div>
					<span class="image-block">
						<a class="image-zoom" href="<?php echo base_url();?>/assets/web/images/g2.jpg" data-gal="prettyPhoto[gallery]">
			...
			<li class="portfolio-item2" data-id="id-2" data-type="cat-item-1">
				<div>
					<span class="image-block">
						<a class="image-zoom" href="<?php echo base_url();?>/assets/web/images/g3.jpg" data-gal="prettyPhoto[gallery]">
			...
			<li class="portfolio-item2" data-id="id-3" data-type="cat-item-4">
				<div>
					<span class="image-block">
						<a class="image-zoom" href="<?php echo base_url();?>/assets/web/images/g4.jpg" data-gal="prettyPhoto[gallery]">
			...
			<li class="portfolio-item2" data-id="id-4" data-type="cat-item-3">
				<div>
					<span class="image-block">
						<a class="image-zoom" href="<?php echo base_url();?>/assets/web/images/g5.jpg" data-gal="prettyPhoto[gallery]">
			...
			<li class="portfolio-item2" data-id="id-5" data-type="cat-item-2">
				<div>
					<span class="image-block">
						<a class="image-zoom" href="<?php echo base_url();?>/assets/web/images/g6.jpg" data-gal="prettyPhoto[gallery]">
			...
			<li class="portfolio-item2" data-id="id-6" data-type="cat-item-1">
				<div>
					<span class="image-block">
						<a class="image-zoom" href="<?php echo base_url();?>/assets/web/images/g7.jpg" data-gal="prettyPhoto[gallery]">
			...
			<li class="portfolio-item2" data-id="id-7" data-type="cat-item-1">
				<div>
					<span class="image-block">
						<a class="image-zoom" href="<?php echo base_url();?>/assets/web/images/g8.jpg" data-gal="prettyPhoto[gallery]">
			...
			<li class="portfolio-item2" data-id="id-9" data-type="cat-item-4">
				<div>
					<span class="image-block">
						<a class="image-zoom" href="<?php echo base_url();?>/assets/web/images/g9.jpg" data-gal="prettyPhoto[gallery]">
			...
			<li class="portfolio-item2" data-id="id-9" data-type="cat-item-3">
				<div>
					<span class="image-block">
						<a class="image-zoom" href="<?php echo base_url();?>/assets/web/images/g10.jpg" data-gal="prettyPhoto[gallery]">
			...
			<li class="portfolio-item2" data-id="id-10" data-type="cat-item-2">
				<div>
					<span class="image-block">
						<a class="image-zoom" href="<?php echo base_url();?>/assets/web/images/g11.jpg" data-gal="prettyPhoto[gallery]">
			...
			<li class="portfolio-item2" data-id="id-8" data-type="cat-item-1">
				<div>
					<span class="image-block">
						<a class="image-zoom" href="<?php echo base_url();?>/assets/web/images/g12.jpg" data-gal="prettyPhoto[gallery]">
