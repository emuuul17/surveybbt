			...
			<li class="portfolio-item2" data-id="id-0" data-type="cat-item-4">
				<div>
					<span class="image-block img-hover">
						<a class="image-zoom" href="<?php echo base_url();?>/assets/upload/kegiatan/<?= $f->img ?>" data-gal="prettyPhoto[gallery]">
							<img src="<?php echo base_url();?>/assets/upload/kegiatan/<?= $f->img ?>" class="img-fluid w3layouts agileits" alt="">
						</a>
					</span>
				</div>
			</li>
